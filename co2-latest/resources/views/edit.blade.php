                    ...
                    <div class="row">
                        ...
                        <div class="control-group col-12">
                            ...
                            <input type="text" id="bedrijfnaam" class="form-control" name="bedrijfnaam"
                                placeholder="bedrijfnaam hier" value="{{ $post->bedrijfnaam }}" required maxlength="254">
                        </div>

                        <div class="control-group col-12 mt-2">
                            <label for="postcode">Postcode</label>
                            <input type="number" id="postcode" class="form-control" name="postcode"
                                placeholder="postcode hier" min="1000" max="9999" required value="{{ $post->postcode }}">
                        </div>
                        ...
                        <div class="control-group col-12">
                            ...
                            <select id="branche" name="branche" required value="{{ $post->branche }}">
                        ...
                        <div class="control-group col-12 mt-2">
                            ...
                            <input type="number" id="werknemers" class="form-control" name="werknemers"
                                placeholder="werknemers hier" required min="1" max="100000000" maxlength="11" value="{{ $post->werknemers }}">
                        </div>

                        <div class="control-group col-12">
                            <label for="gebouwen">Aantal gebouwen</label>
                            <input type="number" id="gebouwen" class="form-control" name="gebouwen"
                                placeholder="gebouwen hier" required min="1" max="100000000" maxlength="11" value="{{ $post->gebouwen }}">
                        </div>

                        <div class="control-group col-12 mt-2">
                            <label for="grondoppervlak">Grondoppervlak</label>
                            <input type="number" id="grondoppervlak" class="form-control" name="grondoppervlak"
                                placeholder="grondoppervlak hier" required min="1" max="100000000" maxlength="11" value="{{ $post->grondoppervlak }}">
                        ...
                        <div class="control-group col-12">
                            ...
                            <input type="number" id="bouwoppervlak" class="form-control" name="bouwoppervlak"
                                placeholder="bouwoppervlak hier" required min="1" max="100000000" maxlength="11" value="{{ $post->bouwoppervlak }}">
                            <span> m<sup>2</sup></span>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="control-group col-12 text-center">
                            ...
                            <a href="/bedrijven/{{ $post->id }}" class="btn btn-outline-primary btn-danger">Ga terug</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="control-group col-12">
                                ...
                                <input type="text" id="bedrijfnaam" class="form-control" name="bedrijfnaam"
                                    placeholder="bedrijfnaam hier" required value="{{ $post->bedrijfnaam }}">
                            </div>
                            ...
                            <div class="control-group col-12 mt-2">
                                <label for="werknemers">Aantal werknemers</label>
                                <input type="number" id="werknemers" class="form-control" name="werknemers"
                                    placeholder="werknemers hier" required min="1" value="{{ $post->werknemers }}">
                            </div>

                            <div class="control-group col-12">
                                <label for="gebouwen">Aantal gebouwen</label>
                                <input type="number" id="gebouwen" class="form-control" name="gebouwen"
                                    placeholder="gebouwen hier" required min="1" value="{{ $post->gebouwen }}">
                            </div>

                            <div class="control-group col-12 mt-2">
                                <label for="grondoppervlak">Grondoppervlak</label>
                                <input type="number" id="grondoppervlak" class="form-control" name="grondoppervlak"
                                    placeholder="grondoppervlak hier" required min="1" value="{{ $post->grondoppervlak }}">
                                <span> m<sup>2</sup></span>
                            </div>
                            ...
                            <div class="control-group col-12">
                                <label for="bouwoppervlak">Bouwoppervlak</label>
                                <input type="number" id="bouwoppervlak" class="form-control" name="bouwoppervlak"
                                    placeholder="bouwoppervlak hier" required min="1" value="{{ $post->bouwoppervlak }}">
                                <span> m<sup>2</sup></span>
                            </div>
                        </div>
                        <div class="row mt-2">
