    ...
    <div class="container">
        <div class="row">
            <div class="col-12 pt-2">
                <br>
                <h1 class="display-one"><?php echo e(ucfirst($post->bedrijfnaam)); ?></h1>
                <?php
                $array = (array) $post;
                ...
                ?>
                <p></p> 
                <a href="/bedrijven/<?php echo e($post->id); ?>/edit" class="btn btn-outline-primary btn-success">Bewerk Data</a>
                <br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\my-blog\resources\views/show.blade.php ENDPATH**/ ?>